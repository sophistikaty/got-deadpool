(function(){
    ...
    const characters = [
        ...
        { name: rhaegal, displayName:'Rhaegal', alive: false, 
        pic:'https://media.giphy.com/media/3o7aD7sVU7LEsLBcRO/giphy.gif'},
        { name: missandei, displayName:'Missandei', alive: false, 
        ...
        { name: night, displayName:'Night King', alive: false, 
        ...
        { name: jaime, displayName:'Jaime Lannister', alive: false, 
        ...
        { name: qyburn, displayName:'Qyburn', alive: false, 
        pic:'https://media.giphy.com/media/7FBvgMbMuXbcA/giphy.gif'},
        { name: mountain, displayName:'The Mountain | Ser Gregor Clegane', alive: false, 
        pic:'https://media.giphy.com/media/xUPGcwPoY3UVv8CxEs/giphy.gif'},
        { name: theon, displayName:'Theon Greyjoy', alive: false, 
        ...
        pic:'https://media.giphy.com/media/3oD3YP9t2vJfQmFK1O/giphy.gif'},
        { name: jorah, displayName:'Ser Jorah Mormont', alive: false, 
        ...
        { name: hound, displayName:'The Hound | Ser Sandor Clegane', alive: false, 
        ...
        { name: beric, displayName:'Beric Dondarrion', alive: false, 
        pic:'https://media.giphy.com/media/xUA7bgivQXDhokUguY/giphy.gif'},
        { name: melisandre, displayName:'Melisandre', alive: false, 
        ...
        { name: 'lyanna', displayName:'Lyanna Mormont', alive: false, 
        ...
        pic:'https://vignette.wikia.nocookie.net/gameofthrones/images/c/c7/701_Alys_and_Ned.png/revision/latest?cb=20170826013858'},
        { name: edd, displayName:'Dolorous Edd', alive: false, 
        ...
        { name: euron, displayName:'Euron Greyjoy', alive: false, 
